...
p.nominalBounds = new cjs.Rectangle(0,0,1139,1378);
...
(lib.price2 = function() {
	this.initialize(img.price2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,97,98);


(lib.price3 = function() {
	this.initialize(img.price3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,97,98);
...
p.nominalBounds = new cjs.Rectangle(0,0,64,171);
...
p.nominalBounds = new cjs.Rectangle(0,0,61,170);


(lib.prime04 = function() {
	this.initialize(img.prime04);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,63,172);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-39.95,-184.3,0.2951,0.2951,35.2408);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.dev_veev, new cjs.Rectangle(-210.2,-184.3,411.29999999999995,411.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-32,-90);

	this.instance_2 = new lib.prime03();
	this.instance_2.setTransform(-31,-90);

	this.instance_3 = new lib.prime04();
	this.instance_3.setTransform(-32,-90);
...
p.nominalBounds = new cjs.Rectangle(-32,-90,64,172);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_10
	this.instance_3 = new lib.price_1();
	this.instance_3.setTransform(53.25,-58.5,0.9206,0.9206);

	this.instance_4 = new lib.price3();
	this.instance_4.setTransform(-69,-40,0.9206,0.9204);

	this.instance_5 = new lib.price2();
	this.instance_5.setTransform(-2,-61,0.9206,0.9204);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3}]},19).to({state:[]},1).to({state:[{t:this.instance_4}]},19).to({state:[]},1).to({state:[{t:this.instance_5}]},19).wait(1));

	// Layer_3
	this.instance_6 = new lib.mc_time();
	this.instance_6.setTransform(-103.55,-209.5);
	...
	this.instance_7 = new lib.mc_time2();
	this.instance_7.setTransform(0,-209.5);
	...
	this.instance_8 = new lib.mc_time3();
	this.instance_8.setTransform(103.55,-210.5);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_6}]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.instance_7}]},20).to({state:[{t:this.shape_3},{t:this.instance_8}]},20).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.dev_one_1).wait(40).to({_off:false},0).to({regX:-0.1,regY:-0.4,scaleX:0.5492,scaleY:0.5492,rotation:-44.149,x:-115.9,y:10.75},19).wait(1));

	// Layer_8
	this.dev_one_2 = new lib.dev_veev();
	this.dev_one_2.name = "dev_one_2";
	this.dev_one_2.setTransform(-115.9,10.75,0.5492,0.5492,-44.149,0,0,-0.1,-0.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.dev_one_2).to({regY:-0.2,scaleX:0.5916,scaleY:0.5916,rotation:-46.5519,x:93.6,y:1.55},19).to({_off:true},1).wait(40));
	...
	// Layer_4
	this.instance_9 = new lib.BG02();
	this.instance_9.setTransform(-213,-225,0.375,0.375);
...
p.nominalBounds = new cjs.Rectangle(-269,-243.2,544.5,535);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_5
	this.instance = new lib.warning();
	this.instance.setTransform(160,453.75,1.0024,1.0024);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(55));

	// Layer_11
	this.instance_1 = new lib.txt01();
	this.instance_1.setTransform(166.65,98.5,0.6281,0.6281,0,0,0,0,0.1);
...
p.nominalBounds = new cjs.Rectangle(51.5,233.5,323.2,276.8);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/price2.png", id:"price2"},
		{src:"images/price3.png", id:"price3"},
